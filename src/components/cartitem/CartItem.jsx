...
const CartItem = (props) => {
    ...
    return (
        <tr className="CartRow">
            ...
            <td className="CartCell"><button className="CartListBtn CartListBenMin" onClick={() => removeFromCart(item)}>-</button> {quantity} <button className="CartListBtn CartListBeAdd" onClick={() => addToCart(item)}>+</button></td>
