    ...
    return (
        <div className="Footer">
            ...
            <div className="container_form">
                <h2 className="title_form">Contactez-nous</h2>
                <Link to='/contact' ><img src={LogoFormulaireDeContact} className="formIcon" /></Link>
            </div>
            ...
            <div className="container_linkedin">
                ...
                <div className="container_icon">
                    <p className="container_name">Guillaume Cregut</p>
